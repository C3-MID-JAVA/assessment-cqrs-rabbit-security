...
public class LoginAdminUseCaseTest {
    ...
    void shouldThrowNotFoundExceptionWhenAdminNotFound() {
        String email = "notfound@test.com";  // Cambié el correo
    ...
    void shouldThrowAccessDeniedExceptionWhenPasswordIsInvalid() {
        ...
        String password = "incorrectPassword";  // Cambié la contraseña
    ...
    void shouldReturnAdminResponseWhenLoginIsSuccessful() {
        String email = "newadmin@test.com";  // Cambié el correo
        String password = "password123";
        String hashedPassword = "hashedPassword";
        String token = "jwtToken";
        String role = "GOD";

        AdminDTO adminDTO = new AdminDTO("admin-2", email, hashedPassword, ROLE.GOD);
        ...
        StepVerifier.create(useCase.execute(command))
                .consumeNextWith(response -> {
                    ...
                    assertEquals("admin-2", response.getId());  // Cambié el ID
