...
public class CreateDepositUseCase implements IUseCase<CreateTransactionCommand, TransactionResponse> {

    private final ProcessTransactionUseCase processTransactionUseCase;
    private final IBusEvent busMessage;

    public CreateDepositUseCase(ProcessTransactionUseCase processTransactionUseCase, IBusEvent busMessage) {
