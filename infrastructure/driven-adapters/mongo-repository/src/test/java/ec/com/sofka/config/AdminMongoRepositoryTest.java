...
public class AdminMongoRepositoryTest {
    ...
    @BeforeAll
    void setup() {
        admin1 = new AdminEntity("admin1@example.com", "password1", RoleEnum.SUPER_ADMIN);
        admin2 = new AdminEntity("admin2@example.com", "password2", RoleEnum.SUPER_ADMIN);
    }
    ...
    void save_shouldPersistAdmin() {
        AdminEntity newAdmin = new AdminEntity("admin3@example.com", "password3",RoleEnum.SUPER_ADMIN);
